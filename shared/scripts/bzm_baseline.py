#!/usr/bin/env python3
"""Pure baseline logic for the `blazemeter-baseline` skill.
...
# baseline (consistent with how compare-blazemeter-runs treats those statuses).
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(
        description="Pure baseline logic for the blazemeter-baseline skill "
