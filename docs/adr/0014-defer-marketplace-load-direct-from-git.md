...
`blazemeter-perfecto@skills-dir`. Publishing through the self-hosted marketplace is **deferred**
...
Unchanged from ADR-0006: it's still a namespaced Claude Code plugin (`blazemeter-perfecto:<skill>`),
