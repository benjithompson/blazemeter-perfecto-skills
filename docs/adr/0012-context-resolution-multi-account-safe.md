...
`skills/bzm-analyze-test` Step 0 *(the reference skill is now `skills/bzm-test-analysis` after the
ADR-0020 consolidation)*. These three move together — the reference implementation and
